...
public class GameView2 extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private PongGame2 pongGame;


    private MotionEvent event;
    public GameView2(Context context, FirebaseUser user, FirebaseDatabase database) {
        super(context);
        ...
        pongGame = new PongGame2(context, displayMetrics.heightPixels, displayMetrics.widthPixels,
                user, database);
    }
